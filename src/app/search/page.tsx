        ...
        <div className="max-w-6xl mx-auto px-6 lg:px-10 py-4">
          <form onSubmit={handleSearch} className="flex gap-2">
            <div className="relative flex-1">
              ...
              {query && (
                <button type="button" onClick={() => setQuery('')} className="absolute right-3 top-1/2 -translate-y-1/2 text-[#6B5E52]">
            ...
            <div className="flex-1 min-w-0">
              <div className="flex items-center justify-between mb-6">
                <p className="text-[15px] font-medium">
                  {results.length} tool{results.length !== 1 ? 's' : ''} found{zip ? ` near ${zip}` : ''}
                </p>
