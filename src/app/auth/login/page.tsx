      ...
      <div className="w-full max-w-[400px]">
        ...
        <div className="text-center mb-8">
          <Link href="/" className="inline-flex items-center gap-2 group">
            <div className="w-9 h-9 bg-brand rounded-xl flex items-center justify-center rotate-12 group-hover:rotate-0 transition-transform duration-300">
              <Wrench className="w-4.5 h-4.5 text-white -rotate-12 group-hover:rotate-0 transition-transform duration-300" />
            </div>
        ...
        <div className="bg-white border border-sand rounded-2xl p-8 shadow-card">
          ...
          <form onSubmit={handleSubmit} className="space-y-4">
            <div>
              <label className="block text-[13px] font-medium mb-1.5" htmlFor="email">
                Email address
              </label>
              <input
            ...
            <div>
              <div className="flex justify-between items-center mb-1.5">
                ...
                <Link href="/auth/forgot-password" className="text-[12px] text-brand hover:underline">
                  Forgot password?
                </Link>
              </div>
